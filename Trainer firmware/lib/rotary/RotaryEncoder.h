...
class Versatile_RotaryEncoder {
    public:
        ...
        #else
        using functionHandleRotary = void (*)(int8_t rotation, uint8_t& num);
    ...
    public:
        Versatile_RotaryEncoder(uint8_t clk, uint8_t dt, uint8_t sw, uint8_t& num);
        bool ReadEncoder();
