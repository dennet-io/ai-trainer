 ...
 * Added a private var num_ to the class and changed function handles 
 * to suit specific use case. Other than that, all credits remain for
 * Rui Seixas Monteiro.
*/
...
namespace Expedition {
    ...
    Versatile_RotaryEncoder::Versatile_RotaryEncoder(uint8_t clk, uint8_t dt, uint8_t sw, uint8_t& num) : num_(num) {
